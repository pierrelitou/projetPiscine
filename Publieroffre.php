...
<head>
	<title>accueil</title>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="Publieroffre.css">
</head>
<body>
	...
	<main>
		<form method="post" action="OffrePoste.php">
			L'entreprise recrutante :<br> <textarea cols="80" rows="1" name="entreprise" value="ex : Thales, Total, Carrefour ..."></textarea> <br>
			Le poste : <br>
			Titre de l'annonce :<br> <textarea cols="80" rows="1" name="titre" value="ex : Assistant Marketing"></textarea> <br>
			Mission : <br> <textarea cols="80" rows="3" name="mission"></textarea> <br>
			Date de début : <br> <input type="date" name="debut"><br>
			Contrat : <br> <select name="contrat" id="contrat">
           ...
           <option value="Intérimaire">Intérimaire</option>
			...
			Durée : <br> <select name="duree" id="duree">
			...
			Métier/Domaine : <br> <select name="domaine" id="domaine">
			...
			<br>
			Ville : <br>
			<textarea cols="80" rows="1" name="ville"></textarea> <br>
			Profil Recherché : <br>
			Description du profil : <br>
			<textarea cols="80" rows="3" name="profil"></textarea><br>
			Niveau d'étude : <br> <select name="niveau" id="niveau">
			...
			<br>
			<input type="submit" name="valider" value="Poster l'annonce">
			</form>
